...
// content-pattern matcher. Keeping one implementation means "highlights on a
// word" and "ignore -pattern that word" agree on word boundaries, glob
// translation, and URL stripping. The client keeps its own mirror of these in
// vue_client/src/utils/ignoreMatch.ts — any change here must land there too.
...
// fuse into a false match. Uses the same URL definition the client uses to
// auto-link, so "renders as a link" and "matched" stay in lockstep.
